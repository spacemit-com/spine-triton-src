...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        llvm_root_dir = os.environ["LLVM_ROOT_DIR"]
        cmake_args.extend(["-DLLVM_INCLUDE_DIRS={}/include".format(llvm_root_dir)])
        cmake_args.extend(["-DLLVM_LIBRARY_DIR={}/lib".format(llvm_root_dir)])
        cmake_args.extend(["-DLLVM_SYSPATH={}".format(llvm_root_dir)])
